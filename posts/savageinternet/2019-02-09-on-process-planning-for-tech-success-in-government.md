...
![Header Image](/img/savageinternet/dilbert-agile.gif "Dilbert comic strip.  PHB: We're going to try something called Agile Programming. // That means no more planning and no more documentation.  Just start writing code and complaining. // Wally: I'm glad it has a name.  // PHB: That was your training.")
...
![Whiteboard Data Map](/img/savageinternet/data-map-whiteboard.jpg "Whiteboard flowchart showing how collision and traffic volume data move between organizations and divisions at the City of Toronto")
...
![Printed Data Map](/img/savageinternet/data-map-printed.jpg "Printed data map, complete with fancy colours and names attached to the various divisions")
...
![Tech Strategy Header](/img/savageinternet/tech-strategy-header.png "Header of our tech strategy document, detailing our high-level goals")
...
![Tech Strategy Header](/img/savageinternet/vpc-elb-stack.png "City of Toronto AWS stack")
...
{% blockquote "January Project Panel Slides" d %}
...
![Sample Application Login](/img/savageinternet/sample-login.png "Sample Application Login Page")
...
![Sample Application Homepage](/img/savageinternet/sample-home.png "Sample Application Home Page")
...
![Sample Application Dynamic](/img/savageinternet/sample-about.png "Sample Application Dynamic About Page")
...
{% blockquote "John F. Woods", "https://groups.google.com/forum/#!msg/comp.lang.c++/rYCO5yn4lXw/oITtSkZOtoUJ", "comp.lang.c++" d %}
